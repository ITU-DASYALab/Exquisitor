...
int main(int argc, char *argv[])
{
	...
	sprintf(script, "INSERT INTO example_dataset VALUES FROM MEMORY %d", HDFql::variableGetNumber(values));
	...
	sprintf(script, "SELECT FROM example_dataset INTO MEMORY %d", HDFql::variableGetNumber(values));
	HDFql::execute(script);
